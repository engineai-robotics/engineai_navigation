...
"""Real-robot CustomMsg preprocessor.

The robot URDF TF is not running on hardware, so skip livox_frame lookup
and use the calibrated static pose in LINK_TORSO_YAW.
"""
