...
from engineai_rl_lab.tasks.navigation.mdp.delay_manager import ObservationDelayManager

if TYPE_CHECKING:
    from engineai_rl_lab.tasks.navigation.navigation_env_cfg import NavigationEnvCfg
